...
def create_project(on_create_project):
        ...
        #Variables
        locations = [
            Location("Trujillo", True, "35° 41' 22'' N ", "images/prueba.png"),
            Location("Amazonas", True, "36° 41' 22'' N", "images/prueba.png"),
            Location("Ucayali", False, "37° 41' 22'' N", "images/prueba.png"),
            Location("Trujillo", True, "35° 41' 22'' N ", "images/prueba.png"),
            Location("Amazonas", False, "36° 41' 22'' N", "images/prueba.png"),
            Location("Amazonas", True, "36° 41' 22'' N", "images/prueba.png"),
            Location("Ucayali", False, "37° 41' 22'' N", "images/prueba.png"),
            Location("Trujillo", True, "35° 41' 22'' N ", "images/prueba.png"),
        ]
        ...
        container_2.set_margin_start(80)
        container_2.set_margin_end(80)
        ...
        container_1.append(create_add_button())
...
def create_add_button(on_create_project):
                ...
                # add_button.connect("clicked", lambda x: self.on_search_clicked())
                # add_button.connect("clicked", self.on_create_project)
...
def on_search_clicked(self):
                self.new_window = NewProjectWindow()
...
def on_file_dialog_response(self, dialog, response):
                if response == Gtk.ResponseType.ACCEPT:
                    self.selected_file_path = dialog.get_file().get_path()  #Alamcena el archivo
                    print("Archivo seleccionado: ", self.selected_file_path)
                else:
